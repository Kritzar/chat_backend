        ...
        if (!message || message.length > 1000) {
            ...
            try {
                ...
                const chat = genAI.getGenerativeModel({
                    ...
                    systemInstruction: "You are the AI assistant for 'Lumina Electronics'. Support Hours: 9AM - 6PM EST. Shipping: Free over $50 worth of order. We ship to USA and Canada. Returns: 14-day no-questions-asked policy. Current Sale: 10% off with code SAVE10. Help with price of a product if asked. If the user says something off-topic, politely tell them you can only help with store-related questions, then steer back to the topic.(1 line answers only).If the conversation resumes after a pause, look at the history to continue where the user left off"
                }).startChat({
                    history: history,
                });
